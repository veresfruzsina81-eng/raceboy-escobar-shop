...
def build_store_context(products, product_count_in_cart=0, word=''):
    return {
        'products': products,
        'raceboy_products': products.filter(category='RACEBOY'),
        'escobar_products': products.filter(category='ESCOBAR'),
        'kozos_products': products.filter(category='KOZOS'),
...
def home_view(request):
    ...
    return render(request, 'ecom/index.html', build_store_context(products, product_count_in_cart))
...
def search_view(request):
    ...
    if request.user.is_authenticated:
        return render(request, 'ecom/customer_home.html', build_store_context(products, product_count_in_cart, word))
    return render(request, 'ecom/index.html', build_store_context(products, product_count_in_cart, word))
...
def customer_home_view(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request, 'ecom/customer_home.html', build_store_context(products, product_count_in_cart))
